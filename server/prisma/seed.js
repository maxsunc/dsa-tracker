...
// ── NeetCode 150 — complete problem list with topic ordering ──
const problems = [
  // ── Arrays & Hashing (9) ────────────────────────────────
  { leetcodeNumber: 217, title: 'Contains Duplicate',                      difficulty: 'easy',   category: 'Arrays & Hashing',      pattern: 'Hash Set',          leetcodeUrl: 'https://leetcode.com/problems/contains-duplicate/' },
  { leetcodeNumber: 242, title: 'Valid Anagram',                           difficulty: 'easy',   category: 'Arrays & Hashing',      pattern: 'Hash Map',          leetcodeUrl: 'https://leetcode.com/problems/valid-anagram/' },
  { leetcodeNumber: 1,   title: 'Two Sum',                                difficulty: 'easy',   category: 'Arrays & Hashing',      pattern: 'Hash Map',          leetcodeUrl: 'https://leetcode.com/problems/two-sum/' },
  { leetcodeNumber: 49,  title: 'Group Anagrams',                         difficulty: 'medium', category: 'Arrays & Hashing',      pattern: 'Hash Map',          leetcodeUrl: 'https://leetcode.com/problems/group-anagrams/' },
  { leetcodeNumber: 347, title: 'Top K Frequent Elements',                difficulty: 'medium', category: 'Arrays & Hashing',      pattern: 'Bucket Sort',       leetcodeUrl: 'https://leetcode.com/problems/top-k-frequent-elements/' },
  { leetcodeNumber: 238, title: 'Product of Array Except Self',           difficulty: 'medium', category: 'Arrays & Hashing',      pattern: 'Prefix/Suffix',     leetcodeUrl: 'https://leetcode.com/problems/product-of-array-except-self/' },
  { leetcodeNumber: 36,  title: 'Valid Sudoku',                           difficulty: 'medium', category: 'Arrays & Hashing',      pattern: 'Hash Set',          leetcodeUrl: 'https://leetcode.com/problems/valid-sudoku/' },
  { leetcodeNumber: 271, title: 'Encode and Decode Strings',              difficulty: 'medium', category: 'Arrays & Hashing',      pattern: 'String',            leetcodeUrl: 'https://leetcode.com/problems/encode-and-decode-strings/' },
  { leetcodeNumber: 128, title: 'Longest Consecutive Sequence',           difficulty: 'medium', category: 'Arrays & Hashing',      pattern: 'Hash Set',          leetcodeUrl: 'https://leetcode.com/problems/longest-consecutive-sequence/' },
  // ── Two Pointers (5) ───────────────────────────────────
  ...
  { leetcodeNumber: 15,  title: '3Sum',                                   difficulty: 'medium', category: 'Two Pointers',          pattern: 'Two Pointers',      leetcodeUrl: 'https://leetcode.com/problems/3sum/' },
  { leetcodeNumber: 11,  title: 'Container with Most Water',              difficulty: 'medium', category: 'Two Pointers',          pattern: 'Two Pointers',      leetcodeUrl: 'https://leetcode.com/problems/container-with-most-water/' },
  ...
  // ── Sliding Window (6) ─────────────────────────────────
  { leetcodeNumber: 121, title: 'Best Time to Buy & Sell Stock',          difficulty: 'easy',   category: 'Sliding Window',        pattern: 'Sliding Window',    leetcodeUrl: 'https://leetcode.com/problems/best-time-to-buy-and-sell-stock/' },
  ...
  { leetcodeNumber: 567, title: 'Permutation in String',                  difficulty: 'medium', category: 'Sliding Window',        pattern: 'Sliding Window',    leetcodeUrl: 'https://leetcode.com/problems/permutation-in-string/' },
  ...
  { leetcodeNumber: 33,  title: 'Search in Rotated Sorted Array',         difficulty: 'medium', category: 'Binary Search',         pattern: 'Binary Search',     leetcodeUrl: 'https://leetcode.com/problems/search-in-rotated-sorted-array/' },
  { leetcodeNumber: 153, title: 'Find Minimum in Rotated Sorted Array',   difficulty: 'medium', category: 'Binary Search',         pattern: 'Binary Search',     leetcodeUrl: 'https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/' },
  { leetcodeNumber: 981, title: 'Time Based Key-Value Store',             difficulty: 'medium', category: 'Binary Search',         pattern: 'Binary Search',     leetcodeUrl: 'https://leetcode.com/problems/time-based-key-value-store/' },
  ...
  // ── Linked List (11) ───────────────────────────────────
  { leetcodeNumber: 206, title: 'Reverse Linked List',                    difficulty: 'easy',   category: 'Linked List',           pattern: 'Linked List',       leetcodeUrl: 'https://leetcode.com/problems/reverse-linked-list/' },
  { leetcodeNumber: 21,  title: 'Merge Two Sorted Lists',                 difficulty: 'easy',   category: 'Linked List',           pattern: 'Linked List',       leetcodeUrl: 'https://leetcode.com/problems/merge-two-sorted-lists/' },
  { leetcodeNumber: 143, title: 'Reorder List',                           difficulty: 'medium', category: 'Linked List',           pattern: 'Fast & Slow',       leetcodeUrl: 'https://leetcode.com/problems/reorder-list/' },
  { leetcodeNumber: 19,  title: 'Remove Nth Node from End of List',       difficulty: 'medium', category: 'Linked List',           pattern: 'Two Pointers',      leetcodeUrl: 'https://leetcode.com/problems/remove-nth-node-from-end-of-list/' },
  { leetcodeNumber: 138, title: 'Copy List with Random Pointer',          difficulty: 'medium', category: 'Linked List',           pattern: 'Hash Map',          leetcodeUrl: 'https://leetcode.com/problems/copy-list-with-random-pointer/' },
  { leetcodeNumber: 2,   title: 'Add Two Numbers',                       difficulty: 'medium', category: 'Linked List',           pattern: 'Linked List',       leetcodeUrl: 'https://leetcode.com/problems/add-two-numbers/' },
  { leetcodeNumber: 141, title: 'Linked List Cycle',                      difficulty: 'easy',   category: 'Linked List',           pattern: 'Fast & Slow',       leetcodeUrl: 'https://leetcode.com/problems/linked-list-cycle/' },
  { leetcodeNumber: 287, title: 'Find the Duplicate Number',              difficulty: 'medium', category: 'Linked List',           pattern: 'Fast & Slow',       leetcodeUrl: 'https://leetcode.com/problems/find-the-duplicate-number/' },
  { leetcodeNumber: 146, title: 'LRU Cache',                              difficulty: 'medium', category: 'Linked List',           pattern: 'Hash Map + DLL',    leetcodeUrl: 'https://leetcode.com/problems/lru-cache/' },
  { leetcodeNumber: 23,  title: 'Merge K Sorted Lists',                   difficulty: 'hard',   category: 'Linked List',           pattern: 'Heap',              leetcodeUrl: 'https://leetcode.com/problems/merge-k-sorted-lists/' },
  { leetcodeNumber: 25,  title: 'Reverse Nodes in K-Group',               difficulty: 'hard',   category: 'Linked List',           pattern: 'Linked List',       leetcodeUrl: 'https://leetcode.com/problems/reverse-nodes-in-k-group/' },
  // ── Trees (15) ─────────────────────────────────────────
  ...
  { leetcodeNumber: 235, title: 'Lowest Common Ancestor of a BST',        difficulty: 'medium', category: 'Trees',                 pattern: 'BST',               leetcodeUrl: 'https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/' },
  ...
  { leetcodeNumber: 1448, title: 'Count Good Nodes in Binary Tree',       difficulty: 'medium', category: 'Trees',                 pattern: 'DFS',               leetcodeUrl: 'https://leetcode.com/problems/count-good-nodes-in-binary-tree/' },
  ...
  // ── Tries (3) ──────────────────────────────────────────
  { leetcodeNumber: 208, title: 'Implement Trie (Prefix Tree)',           difficulty: 'medium', category: 'Tries',                 pattern: 'Trie',              leetcodeUrl: 'https://leetcode.com/problems/implement-trie-prefix-tree/' },
  ...
  { leetcodeNumber: 212, title: 'Word Search II',                         difficulty: 'hard',   category: 'Tries',                 pattern: 'Trie + Backtrack',  leetcodeUrl: 'https://leetcode.com/problems/word-search-ii/' },
  // ── Heap / Priority Queue (7) ──────────────────────────
  { leetcodeNumber: 703, title: 'Kth Largest Element in a Stream',        difficulty: 'easy',   category: 'Heap / Priority Queue', pattern: 'Min Heap',          leetcodeUrl: 'https://leetcode.com/problems/kth-largest-element-in-a-stream/' },
  { leetcodeNumber: 1046, title: 'Last Stone Weight',                     difficulty: 'easy',   category: 'Heap / Priority Queue', pattern: 'Max Heap',          leetcodeUrl: 'https://leetcode.com/problems/last-stone-weight/' },
  { leetcodeNumber: 973, title: 'K Closest Points to Origin',             difficulty: 'medium', category: 'Heap / Priority Queue', pattern: 'Min Heap',          leetcodeUrl: 'https://leetcode.com/problems/k-closest-points-to-origin/' },
  { leetcodeNumber: 215, title: 'Kth Largest Element in an Array',        difficulty: 'medium', category: 'Heap / Priority Queue', pattern: 'Quick Select',      leetcodeUrl: 'https://leetcode.com/problems/kth-largest-element-in-an-array/' },
  { leetcodeNumber: 621, title: 'Task Scheduler',                         difficulty: 'medium', category: 'Heap / Priority Queue', pattern: 'Greedy + Heap',     leetcodeUrl: 'https://leetcode.com/problems/task-scheduler/' },
  { leetcodeNumber: 355, title: 'Design Twitter',                         difficulty: 'medium', category: 'Heap / Priority Queue', pattern: 'Heap + Hash Map',   leetcodeUrl: 'https://leetcode.com/problems/design-twitter/' },
  { leetcodeNumber: 295, title: 'Find Median from Data Stream',           difficulty: 'hard',   category: 'Heap / Priority Queue', pattern: 'Two Heaps',         leetcodeUrl: 'https://leetcode.com/problems/find-median-from-data-stream/' },
  // ── Backtracking (9) ───────────────────────────────────
  ...
  { leetcodeNumber: 286, title: 'Walls and Gates',                        difficulty: 'medium', category: 'Graphs',                pattern: 'BFS',               leetcodeUrl: 'https://leetcode.com/problems/walls-and-gates/' },
  ...
  { leetcodeNumber: 323, title: 'Number of Connected Components in Graph', difficulty: 'medium', category: 'Graphs',               pattern: 'Union Find',        leetcodeUrl: 'https://leetcode.com/problems/number-of-connected-components-in-an-undirected-graph/' },
  ...
  // ── Advanced Graphs (6) ────────────────────────────────
  { leetcodeNumber: 332, title: 'Reconstruct Itinerary',                  difficulty: 'hard',   category: 'Advanced Graphs',       pattern: 'DFS / Euler Path',  leetcodeUrl: 'https://leetcode.com/problems/reconstruct-itinerary/' },
  { leetcodeNumber: 1584, title: 'Min Cost to Connect All Points',        difficulty: 'medium', category: 'Advanced Graphs',       pattern: "Prim's / Kruskal's", leetcodeUrl: 'https://leetcode.com/problems/min-cost-to-connect-all-points/' },
  { leetcodeNumber: 743, title: 'Network Delay Time',                     difficulty: 'medium', category: 'Advanced Graphs',       pattern: "Dijkstra's",        leetcodeUrl: 'https://leetcode.com/problems/network-delay-time/' },
  { leetcodeNumber: 778, title: 'Swim in Rising Water',                   difficulty: 'hard',   category: 'Advanced Graphs',       pattern: 'Binary Search+BFS', leetcodeUrl: 'https://leetcode.com/problems/swim-in-rising-water/' },
  { leetcodeNumber: 269, title: 'Alien Dictionary',                       difficulty: 'hard',   category: 'Advanced Graphs',       pattern: 'Topological Sort',  leetcodeUrl: 'https://leetcode.com/problems/alien-dictionary/' },
  { leetcodeNumber: 787, title: 'Cheapest Flights Within K Stops',        difficulty: 'medium', category: 'Advanced Graphs',       pattern: 'Bellman-Ford',      leetcodeUrl: 'https://leetcode.com/problems/cheapest-flights-within-k-stops/' },
  // ── 1-D Dynamic Programming (12) ───────────────────────
  { leetcodeNumber: 70,  title: 'Climbing Stairs',                        difficulty: 'easy',   category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/climbing-stairs/' },
  { leetcodeNumber: 746, title: 'Min Cost Climbing Stairs',               difficulty: 'easy',   category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/min-cost-climbing-stairs/' },
  { leetcodeNumber: 198, title: 'House Robber',                           difficulty: 'medium', category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/house-robber/' },
  { leetcodeNumber: 213, title: 'House Robber II',                        difficulty: 'medium', category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/house-robber-ii/' },
  { leetcodeNumber: 5,   title: 'Longest Palindromic Substring',          difficulty: 'medium', category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/longest-palindromic-substring/' },
  { leetcodeNumber: 647, title: 'Palindromic Substrings',                 difficulty: 'medium', category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/palindromic-substrings/' },
  { leetcodeNumber: 91,  title: 'Decode Ways',                            difficulty: 'medium', category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/decode-ways/' },
  { leetcodeNumber: 322, title: 'Coin Change',                            difficulty: 'medium', category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/coin-change/' },
  { leetcodeNumber: 152, title: 'Maximum Product Subarray',               difficulty: 'medium', category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/maximum-product-subarray/' },
  { leetcodeNumber: 139, title: 'Word Break',                             difficulty: 'medium', category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/word-break/' },
  { leetcodeNumber: 300, title: 'Longest Increasing Subsequence',         difficulty: 'medium', category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/longest-increasing-subsequence/' },
  { leetcodeNumber: 416, title: 'Partition Equal Subset Sum',             difficulty: 'medium', category: '1-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/partition-equal-subset-sum/' },
  // ── 2-D Dynamic Programming (11) ───────────────────────
  { leetcodeNumber: 62,   title: 'Unique Paths',                          difficulty: 'medium', category: '2-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/unique-paths/' },
  { leetcodeNumber: 1143, title: 'Longest Common Subsequence',            difficulty: 'medium', category: '2-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/longest-common-subsequence/' },
  { leetcodeNumber: 309, title: 'Best Time to Buy/Sell Stock with Cooldown', difficulty: 'medium', category: '2-D Dynamic Programming', pattern: 'DP',           leetcodeUrl: 'https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-cooldown/' },
  { leetcodeNumber: 518, title: 'Coin Change II',                         difficulty: 'medium', category: '2-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/coin-change-2/' },
  { leetcodeNumber: 494, title: 'Target Sum',                             difficulty: 'medium', category: '2-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/target-sum/' },
  { leetcodeNumber: 97,  title: 'Interleaving String',                    difficulty: 'medium', category: '2-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/interleaving-string/' },
  { leetcodeNumber: 329, title: 'Longest Increasing Path in a Matrix',    difficulty: 'hard',   category: '2-D Dynamic Programming', pattern: 'DFS + Memo',      leetcodeUrl: 'https://leetcode.com/problems/longest-increasing-path-in-a-matrix/' },
  { leetcodeNumber: 115, title: 'Distinct Subsequences',                  difficulty: 'hard',   category: '2-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/distinct-subsequences/' },
  { leetcodeNumber: 72,  title: 'Edit Distance',                          difficulty: 'medium', category: '2-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/edit-distance/' },
  { leetcodeNumber: 312, title: 'Burst Balloons',                         difficulty: 'hard',   category: '2-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/burst-balloons/' },
  { leetcodeNumber: 10,  title: 'Regular Expression Matching',            difficulty: 'hard',   category: '2-D Dynamic Programming', pattern: 'DP',              leetcodeUrl: 'https://leetcode.com/problems/regular-expression-matching/' },
  // ── Greedy (8) ─────────────────────────────────────────
  { leetcodeNumber: 53,  title: 'Maximum Subarray',                       difficulty: 'medium', category: 'Greedy',                pattern: "Kadane's",          leetcodeUrl: 'https://leetcode.com/problems/maximum-subarray/' },
...
// Add orderIndex based on position (preserves NeetCode topic ordering)
const indexedProblems = problems.map((p, i) => ({ ...p, orderIndex: i + 1 }));

async function main() {
  console.log('Seeding NeetCode 150 problems...');
  // Clear existing data (cascade)
  await prisma.reviewHistory.deleteMany({});
  await prisma.userProblem.deleteMany({});
  await prisma.problem.deleteMany({});

  for (const problem of indexedProblems) {
    await prisma.problem.create({ data: problem });
  }
  console.log(`Seeded ${indexedProblems.length} NeetCode 150 problems.`);
}
